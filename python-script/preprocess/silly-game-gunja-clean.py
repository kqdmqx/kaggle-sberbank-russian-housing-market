...
).to_csv('../../output/sample/TrainId-SillyGame-Gunja-Clean.csv', index=False)

pd.DataFrame(
    {
        'id': test_id
    }
).to_csv('../../output/sample/TestId-Origin.csv', index=False)
...
).to_csv('../../output/sample/TrainId-SillyGame-Gunja-Outlier.csv', index=False)
